...
module "kube-hetzner" {
  ...
  ssh_private_key = file(var.ssh_key_private_path)
  # You can add additional SSH public Keys to grant other team members root access to your cluster nodes.
  ssh_additional_public_keys = var.ssh_extra_keys_path
  ...
  ssh_hcloud_key_label = var.ssh_extra_keys_label
